...
<head>
  ...
  <link rel="stylesheet" href="/assets/site.css?v=63">
  <script defer src="/assets/site.js?v=26"></script>
</head>
...
page(
    ...
    hero("História", "Uma vida<br><span class=\"mobile-title-keep\">em <em>canções.</em></span>", "Uma trajetória construída entre a música, a fé e as pessoas encontradas pelo caminho.", "history-hero-stage.jpg", "Luiz Arcanjo no palco, com violão e braços abertos sob luzes azuis", variant="history")
    + """
    <section class="section-pad section--ivory"><div class="shell biography-grid">
      <div data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>As primeiras notas</p><h2 class="display-title"><span class="mobile-title-line">A música nasceu</span> <em class="mobile-title-line mobile-title-keep mobile-title-wide">em comunidade.</em></h2></div>
    ...
    <section class="biography-portrait section-pad section--blue"><div class="shell biography-portrait__grid">
      ...
      <div class="biography-portrait__copy" data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>Além do palco</p><h2><span class="mobile-title-line">Arte, palavra</span><br class="desktop-title-break"> <em class="mobile-title-line mobile-title-keep">e serviço.</em></h2><p>Além da música, Luiz é autor de <cite>Por Detrás da Canção</cite> e compartilha sua experiência em iniciativas de ensino. Desde 2017, atua no pastoreio da Sobre as Águas Church, em Nova Iguaçu.</p><p>Essas frentes compõem uma vida dedicada a criar, cuidar e servir.</p><a class="button button--outline" href="/igreja/"><span>Sua atuação pastoral</span><span aria-hidden="true">↗︎</span></a></div>
    </div></section>
    <dialog class="biography-dialog" data-biography-dialog aria-labelledby="biography-dialog-title">
      <div class="biography-dialog__frame">
        ...
        <div class="biography-dialog__scroll">
          ...
          <footer class="biography-dialog__footer"><p>Uma vida dedicada a criar, cuidar e servir.</p><a class="button button--dark" href="/musica/"><span>Conhecer a música</span><span aria-hidden="true">↗︎</span></a></footer>
        </div>
      </div>
    </dialog>
    <section class="section-pad"><div class="shell centered-cta" data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>Continue a explorar</p><h2 class="display-title"><span class="mobile-title-line">A história segue</span> <em class="mobile-title-line mobile-title-keep">em movimento.</em></h2><div class="button-row"><a class="button button--dark" href="/musica/"><span>Ouvir música</span><span aria-hidden="true">↗︎</span></a><a class="button button--outline-dark" href="/livro/"><span>Conhecer o livro</span><span aria-hidden="true">↗︎</span></a></div></div></section>"""
)
...
page(
    ...
    + """
    <section class="section-pad section--ivory" id="cursos"><div class="shell learning-intro"><div data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>Luiz Arcanjo Academy</p><h2 class="display-title"><span class="mobile-title-line">Experiência</span> <span class="mobile-title-line mobile-title-keep">transformada em</span> <em class="mobile-title-line mobile-title-keep">direção prática.</em></h2></div><div class="prose" data-reveal><p>Palco, estúdio, composição, liderança e ministério formaram um repertório de mais de 30 anos. A Academy organiza esse conhecimento para músicos, compositores e líderes que desejam desenvolver técnica, identidade e clareza.</p><p>Cada formação nasce de situações reais e conecta fundamento, prática e acompanhamento.</p></div></div></section>
    <section class="learning-paths section-pad"><div class="shell learning-paths__grid">
      <article class="learning-card" data-reveal><span>01 / Cursos e workshops</span><h2><span class="mobile-title-line mobile-title-keep">Conteúdo para</span> <span class="mobile-title-line">transformar</span> <em class="mobile-title-line mobile-title-keep">prática em</em> <em class="mobile-title-line">repertório.</em></h2><p>Formações sobre música, composição, adoração e os aprendizados reunidos ao longo da trajetória de Luiz Arcanjo.</p><ul><li>Conteúdo estruturado</li><li>Experiência aplicada</li><li>Formatos presenciais e digitais</li></ul><a class="text-link" href="/contato/?assunto=cursos#mensagem">Registrar interesse <span aria-hidden="true">↗︎</span></a></article>
      <article class="learning-card learning-card--blue" id="mentoria" data-reveal><span>02 / Mentoria</span><h2><span class="mobile-title-line">Experiência</span> <span class="mobile-title-line mobile-title-keep">que encontra</span> <em class="mobile-title-line">propósito.</em></h2><p>Conversas orientadas para artistas, líderes e pessoas que desejam clareza para avançar em sua caminhada.</p><ul><li>Escuta e direcionamento</li><li>Planos individuais ou em grupo</li><li>Conexão entre vocação e ação</li></ul><a class="text-link" href="/contato/?assunto=mentoria#mensagem">Falar sobre mentoria <span aria-hidden="true">↗︎</span></a></article>
    </div></section>
    <section class="academy-next section-pad section--blue"><div class="shell academy-next__grid"><div data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>Seu próximo passo</p><h2 class="display-title">Escolha a experiência que responde ao seu <em>momento.</em></h2><p class="lead-serif">Conte à equipe o que você deseja desenvolver. A resposta indicará o formato, a disponibilidade e o caminho mais adequado.</p></div><div class="academy-next__paths" data-reveal><a href="/contato/?assunto=cursos#mensagem"><span>01 / Cursos e workshops</span><strong>Quero desenvolver técnica e repertório.</strong><b aria-hidden="true">↗︎</b></a><a href="/contato/?assunto=mentoria#mensagem"><span>02 / Mentoria</span><strong>Quero direção para uma decisão ou projeto.</strong><b aria-hidden="true">↗︎</b></a></div></div></section>"""
)
...
page(
    ...
    """<section class="book-sales-hero">
      ...
      <div class="shell book-sales-hero__content" data-reveal>
        ...
        <a class="button button--dark" href="https://drafteditora.com.br/produtos/por-detras-da-cancao-luiz-arcanjo-70t8l/" target="_blank" rel="noopener"><span>Adquira o teu</span><span aria-hidden="true">↗︎</span></a>
      </div>
    </section>
    <section class="book-promise section-pad section--ivory" id="livro"><div class="shell book-promise__grid">
      <div data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>O que existe antes do refrão</p><h2 class="display-title"><span class="mobile-title-line">Quando uma</span> <span class="mobile-title-line">canção nasce,</span><br class="desktop-title-break"> <span class="mobile-title-line">uma história</span> <span class="mobile-title-line mobile-title-keep">começa a <em>ecoar.</em></span></h2></div>
    ...
    <section class="book-inside section-pad"><div class="shell book-inside__grid">
      ...
      <div class="book-inside__copy" data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>Dentro da obra</p><h2><span class="mobile-title-line">Memória,</span> <span class="mobile-title-line mobile-title-keep">música e</span><br class="desktop-title-break"> <em class="mobile-title-line mobile-title-keep">testemunho.</em></h2><p>Mais que um registro musical, o livro aproxima o leitor do propósito e das experiências que deram origem a canções ouvidas no Brasil e no mundo.</p><ul class="book-inside__list"><li><span>01</span>Histórias e bastidores jamais revelados ao público</li><li><span>02</span>Letras das canções apresentadas ao longo da narrativa</li><li><span>03</span>Relatos de fé em formato de memórias</li><li><span>04</span>Palheta assinada e marcador de página</li></ul><a class="button button--dark" href="https://drafteditora.com.br/produtos/por-detras-da-cancao-luiz-arcanjo-70t8l/" target="_blank" rel="noopener"><span>Entre nos bastidores das canções</span><span aria-hidden="true">↗︎</span></a></div>
    </div></section>
    <section class="book-signature section-pad section--blue"><div class="shell book-signature__grid">
      <div data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>Da voz para a página</p><h2 class="display-title"><span class="mobile-title-line">Três décadas</span> <span class="mobile-title-line mobile-title-keep">de música,</span><br class="desktop-title-break"> <span class="mobile-title-line mobile-title-keep">agora contadas</span> <span class="mobile-title-line mobile-title-keep">por quem as</span> <em class="mobile-title-line">viveu.</em></h2></div>
...
page(
    ...
    hero("Devocionais", "<span class=\"mobile-title-line mobile-title-keep\">Palavras para</span> <span class=\"mobile-title-line mobile-title-keep\">continuar a</span> <em class=\"mobile-title-line\">caminhada.</em>", "Mensagens, reflexões e conversas para viver a fé com profundidade no cotidiano.", "portrait-olive.jpg", "Luiz Arcanjo com violão", variant="light")
    + """
    ...
    <section class="devotional-videos section-pad"><div class="shell">
      <div class="section-head devotional-section-head" data-reveal><div><p class="eyebrow"><span class="eyebrow__rule"></span>Assista</p><h2 class="display-title"><span class="mobile-title-line mobile-title-keep">Mensagens em</span> <em class="mobile-title-line">vídeo.</em></h2></div><p>Cinco encontros para escolher pelo tema e assistir no seu tempo.</p></div>
      <article class="video-post video-post--featured" data-reveal>
        <a class="video-post__media" href="https://www.youtube.com/watch?v=HMkFJUzOcDk" target="_blank" rel="noopener"><img src="/assets/images/devotional-HMkFJUzOcDk.jpg" alt="Maturidade — mensagem de Luiz Arcanjo" loading="lazy"><span class="video-post__play" aria-hidden="true">▶︎</span><span class="video-post__duration">Mensagem</span></a>
        <div class="video-post__body"><p class="video-post__meta">Mensagem · Quadrangular Búzios</p><h3>Maturidade</h3><p>Uma palavra do Pr. Luiz Arcanjo sobre crescimento, escolhas e a fé que aprende a permanecer.</p><div class="post-actions"><button type="button" data-post-like="video-HMkFJUzOcDk" aria-pressed="false"><span aria-hidden="true">♡</span> Curtir</button><button type="button" data-post-share data-share-title="Maturidade — Pr. Luiz Arcanjo" data-share-url="https://www.youtube.com/watch?v=HMkFJUzOcDk"><span aria-hidden="true">↗︎</span> Compartilhar</button></div></div>
      </article>
      <div class="video-post-grid">
        <article class="video-post" data-reveal><a class="video-post__media" href="https://www.youtube.com/watch?v=dsNY0KoGTM8" target="_blank" rel="noopener"><img src="/assets/images/devotional-dsNY0KoGTM8.jpg" alt="Culto da Resposta com Luiz Arcanjo" loading="lazy"><span class="video-post__play" aria-hidden="true">▶︎</span></a><div class="video-post__body"><p class="video-post__meta">Mensagem · Atitude TV</p><h3>Culto da Resposta</h3><div class="post-actions"><button type="button" data-post-like="video-dsNY0KoGTM8" aria-pressed="false"><span aria-hidden="true">♡</span> Curtir</button><button type="button" data-post-share data-share-title="Culto da Resposta — Luiz Arcanjo" data-share-url="https://www.youtube.com/watch?v=dsNY0KoGTM8"><span aria-hidden="true">↗︎</span> Compartilhar</button></div></div></article>
        <article class="video-post" data-reveal><a class="video-post__media" href="https://www.youtube.com/watch?v=jFT6qQmJJP4" target="_blank" rel="noopener"><img src="/assets/images/devotional-jFT6qQmJJP4.jpg" alt="Nada lhe será impossível segundo a sua fé — mensagem de Luiz Arcanjo" loading="lazy"><span class="video-post__play" aria-hidden="true">▶︎</span></a><div class="video-post__body"><p class="video-post__meta">Mensagem · IPAN</p><h3>Nada lhe será impossível segundo a sua fé</h3><div class="post-actions"><button type="button" data-post-like="video-jFT6qQmJJP4" aria-pressed="false"><span aria-hidden="true">♡</span> Curtir</button><button type="button" data-post-share data-share-title="Nada lhe será impossível segundo a sua fé — Pr. Luiz Arcanjo" data-share-url="https://www.youtube.com/watch?v=jFT6qQmJJP4"><span aria-hidden="true">↗︎</span> Compartilhar</button></div></div></article>
        <article class="video-post" data-reveal><a class="video-post__media" href="https://www.youtube.com/watch?v=GJohQvwXXDA" target="_blank" rel="noopener"><img src="/assets/images/devotional-GJohQvwXXDA.jpg" alt="Fazendo as escolhas certas — mensagem de Luiz Arcanjo" loading="lazy"><span class="video-post__play" aria-hidden="true">▶︎</span></a><div class="video-post__body"><p class="video-post__meta">Mensagem · Mais de Cristo TV</p><h3>Fazendo as escolhas certas</h3><div class="post-actions"><button type="button" data-post-like="video-GJohQvwXXDA" aria-pressed="false"><span aria-hidden="true">♡</span> Curtir</button><button type="button" data-post-share data-share-title="Fazendo as escolhas certas — Luiz Arcanjo" data-share-url="https://www.youtube.com/watch?v=GJohQvwXXDA"><span aria-hidden="true">↗︎</span> Compartilhar</button></div></div></article>
        <article class="video-post" data-reveal><a class="video-post__media" href="https://www.youtube.com/watch?v=rpTqfnBNfsI" target="_blank" rel="noopener"><img src="/assets/images/devotional-rpTqfnBNfsI.jpg" alt="Luiz Arcanjo fala sobre unção, secreto e responsabilidade" loading="lazy"><span class="video-post__play" aria-hidden="true">▶︎</span></a><div class="video-post__body"><p class="video-post__meta">Conversa · Vânia Franco</p><h3>O peso da unção, do secreto e da responsabilidade</h3><div class="post-actions"><button type="button" data-post-like="video-rpTqfnBNfsI" aria-pressed="false"><span aria-hidden="true">♡</span> Curtir</button><button type="button" data-post-share data-share-title="Luiz Arcanjo explica o peso da unção, do secreto e da responsabilidade" data-share-url="https://www.youtube.com/watch?v=rpTqfnBNfsI"><span aria-hidden="true">↗︎</span> Compartilhar</button></div></div></article>
      </div>
    </div></section>
    <section class="devotional-articles section-pad section--blue"><div class="shell">
      <div class="section-head devotional-section-head" data-reveal><div><p class="eyebrow"><span class="eyebrow__rule"></span>Leia</p><h2 class="display-title"><span class="mobile-title-line">Três novas</span> <span class="mobile-title-line mobile-title-keep">leituras,<br class="desktop-title-break"> em</span> <span class="mobile-title-line">preparação <em>editorial.</em></span></h2></div><p>O espaço já está estruturado para receber os primeiros artigos autorais.</p></div>
      <div class="article-preview-grid">
        <article class="article-preview" id="artigo-1" data-reveal><div class="article-preview__image photo"><img src="/assets/images/speaker.jpg" alt="Luiz Arcanjo ministrando" loading="lazy"></div><div class="article-preview__body"><span>01 · Fé no cotidiano</span><h3>A fé que continua depois do culto</h3><p>Artigo em edição.</p><div class="post-actions"><button type="button" data-post-like="article-1" aria-pressed="false"><span aria-hidden="true">♡</span> Curtir</button><button type="button" data-post-share data-share-title="A fé que continua depois do culto" data-share-url="/conteudos/#artigo-1"><span aria-hidden="true">↗︎</span> Compartilhar</button></div></div></article>
        <article class="article-preview" id="artigo-2" data-reveal><div class="article-preview__image photo"><img src="/assets/images/portrait-guitar.jpg" alt="Luiz Arcanjo com violão" loading="lazy"></div><div class="article-preview__body"><span>02 · Música e memória</span><h3>O que uma canção guarda além da letra</h3><p>Artigo em edição.</p><div class="post-actions"><button type="button" data-post-like="article-2" aria-pressed="false"><span aria-hidden="true">♡</span> Curtir</button><button type="button" data-post-share data-share-title="O que uma canção guarda além da letra" data-share-url="/conteudos/#artigo-2"><span aria-hidden="true">↗︎</span> Compartilhar</button></div></div></article>
        <article class="article-preview" id="artigo-3" data-reveal><div class="article-preview__image photo"><img src="/assets/images/history-solo-1221.jpeg" alt="Retrato editorial de Luiz Arcanjo" loading="lazy"></div><div class="article-preview__body"><span>03 · Liderança e serviço</span><h3>Servir também é aprender a permanecer</h3><p>Artigo em edição.</p><div class="post-actions"><button type="button" data-post-like="article-3" aria-pressed="false"><span aria-hidden="true">♡</span> Curtir</button><button type="button" data-post-share data-share-title="Servir também é aprender a permanecer" data-share-url="/conteudos/#artigo-3"><span aria-hidden="true">↗︎</span> Compartilhar</button></div></div></article>
      </div>
    </div></section>"""
)
...
page(
    ...
    """<section class="inner-hero inner-hero--church">
      ...
      <div class="shell inner-hero__content">
        ...
        <a class="button button--outline" href="#conheca"><span>Conheça essa história</span><span aria-hidden="true">↓︎</span></a>
      </div>
    </section>
...
page(
    ...
    <section class="contact-agenda section-pad section--ivory" id="agenda"><div class="shell contact-agenda__grid">
      ...
      </ol><div class="agenda-month__action"><p>Para informações de acesso, consulte os canais oficiais do evento.</p><a class="text-link" href="#mensagem" data-contact-subject="Convite e agenda">Convidar Luiz Arcanjo <span aria-hidden="true">↓︎</span></a></div></div>
    </div></section>
    <section class="contact-channels section-pad" id="canais"><div class="shell"><div class="section-head" data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>Canais oficiais</p><h2 class="display-title"><span class="mobile-title-line">A conversa</span> <span class="mobile-title-line mobile-title-keep">certa,<br class="desktop-title-break"> com a</span> <span class="mobile-title-line">equipe <em>certa.</em></span></h2></div><div class="contact-channel-grid">
      <a class="contact-channel" href="mailto:assessorialuizarcanjo@gmail.com" data-reveal><span>01 / E-mail</span><strong>Assessoria e imprensa</strong><p>assessorialuizarcanjo@gmail.com</p><b aria-hidden="true">↗︎</b></a>
      <a class="contact-channel" href="https://wa.me/5521968315841?text=Ol%C3%A1%2C%20equipe%20do%20Luiz%20Arcanjo%21%20Gostaria%20de%20solicitar%20atendimento." target="_blank" rel="noopener" data-reveal><span>02 / WhatsApp</span><strong>Atendimento da equipe</strong><p>(21) 96831-5841</p><b aria-hidden="true">↗︎</b></a>
      <a class="contact-channel" href="#mensagem" data-contact-subject="Convite e agenda" data-reveal><span>03 / Convites</span><strong>Igrejas e eventos</strong><p>Envie contexto, data e local para análise.</p><b aria-hidden="true">↓︎</b></a>
    </div></div></section>
    <section class="contact-message section-pad section--blue" id="mensagem"><div class="shell invite-grid"><div class="invite-grid__intro" data-reveal><p class="eyebrow"><span class="eyebrow__rule"></span>Fale com a equipe</p><h2 class="display-title"><span class="mobile-title-line">Direcione sua</span> <span class="mobile-title-line mobile-title-keep">mensagem para</span> <span class="mobile-title-line mobile-title-keep">quem pode</span> <em class="mobile-title-line mobile-title-keep">responder.</em></h2><p class="lead-serif">Selecione o assunto e envie os dados necessários. A mensagem seguirá diretamente para a assessoria de Luiz Arcanjo.</p><div class="contact-direct"><span>Prefere escrever?</span><a href="mailto:assessorialuizarcanjo@gmail.com">assessorialuizarcanjo@gmail.com</a></div></div>
      <form class="invite-form contact-form" id="invite-form" action="/api/contact" method="post"><div class="contact-honeypot" aria-hidden="true"><label>Empresa <input name="company" tabindex="-1" autocomplete="off"></label></div><label>Assunto <select name="assunto" id="contact-subject" required><option value="">Selecione o assunto</option><option>Convite e agenda</option><option>Assessoria de imprensa</option><option>Parcerias</option><option>Academy · cursos e workshops</option><option>Academy · mentoria</option><option>Outros assuntos</option></select></label><div class="field-grid"><label>Seu nome <input name="nome" required autocomplete="name" placeholder="Nome e sobrenome"></label><label>E-mail <input name="email" required type="email" autocomplete="email" placeholder="voce@exemplo.com"></label></div><div class="field-grid"><label>Telefone / WhatsApp <input name="telefone" type="tel" autocomplete="tel" placeholder="+55 (00) 00000-0000"></label><label data-invite-field>Organização ou igreja <input name="organizacao" placeholder="Nome da organização"></label></div><div class="field-grid" data-invite-field><label>Tipo de convite <select name="tipo"><option value="">Selecione</option><option>Ministração</option><option>Apresentação musical</option><option>Conferência</option><option>Entrevista</option><option>Outro</option></select></label><label>Data prevista <input name="data" type="date"></label></div><label data-invite-field>Cidade e local <input name="local" placeholder="Cidade, estado e local do evento"></label><label>Mensagem <textarea name="mensagem" rows="6" required placeholder="Conte o contexto e como a equipe pode ajudar"></textarea></label><button class="button button--gold" type="submit"><span>Enviar para a assessoria</span><span aria-hidden="true">↗︎</span></button><p class="form-status" data-form-status aria-live="polite" hidden></p><small>Seus dados serão usados somente para responder a esta solicitação.</small></form>
    </div></section>
    <section class="contact-social shell social-grid" aria-label="Redes sociais"><a href="https://www.instagram.com/luiz_arcanjo/" target="_blank" rel="noopener">Instagram <span>↗︎</span></a><a href="https://www.youtube.com/luizarcanjo" target="_blank" rel="noopener">YouTube <span>↗︎</span></a><a href="https://open.spotify.com/artist/3jhaArlXRtYY9R7GJrvcZ2" target="_blank" rel="noopener">Spotify <span>↗︎</span></a></section>"""
)
